...
function App() {
  ...
  return (
    ...
    <div className="flex w-[40%] mx-10 mt-16 rounded bg-white">
        <input className=" w-full border-none bg-transparent px-4 py-1 text-white-400 outline-none focus:outline-none " type="search" name="search" placeholder="Search for a city" onChange={handleSearch}  />
